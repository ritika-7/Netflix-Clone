  ...
  return(
    <div className="login">
      <div className="holder">
        ...
        <br/>
        <br/>
        { isUserExist && <p className="text-danger">User does not exist | Please Signup Here!</p> }
        { isEmailUsed && <p className="text-danger">Email already in use | Please Signup Here!</p> }
